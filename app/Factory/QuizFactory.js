(function () {
    ...
    function QuizFactory($rootScope, $http, $cookies, APP_VERSION, localStorageService) {
        return {
           init: function() {
               var self = this;
               ...
               if(self.config.APP_VERSION != APP_VERSION) {
                   if (self.config.APP_VERSION < "1.0.0") {
                       self.setConfig("QUIZ", "200-710.json");
    ...
    angular.module('quiz-client').factory('QuizFactory', QuizFactory);
})();
