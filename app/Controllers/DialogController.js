(function () {
    ...
    function DialogController($rootScope, $scope, $window, $timeout, $mdDialog, localStorageService, QuizFactory, APP_VERSION) {
        $scope.repos = loadAll();
        ...
        $scope.save = function () {
            if(QuizFactory.getConfig("QUIZ") != $scope.selectedItem.file) {
    ...
    angular.module('quiz-client').controller('DialogController', DialogController);
})();
